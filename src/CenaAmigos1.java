...
public class CenaAmigos1 {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<cantRecetas; i++) {
			...
			r1.setPreparacion(tecla.nextLine());
		...
		try {
			// crear fichero
			File archivo = new File("/home/zubiri/ProyectosJava/examen/src","listadoRecetas.txt");
			...
			FileWriter fw = new FileWriter("./listadoRecetas.txt");
